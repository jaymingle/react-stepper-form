...
const SecondStep = () => {
    ...
    return (
        <div className="step_container">
            ...
            <TextField value={userData.district} onChange={e => setUserData({...userData, 'district': e.target.value})} label="District" margin="normal" variant="outlined" color="secondary"/>
