    ...
    return (
        <div className="step_container">
            <h3>Step 1</h3>
                ...
                <TextField value={userData.contactNumber} onChange={e => setUserData({...userData, 'contactNumber': e.target.value})} label="Contact Number" margin="normal" variant="outlined" color="secondary"/>
